 ...
 * @version   1.1.0
 */
class XdirHandler extends \XoopsObjectHandler
{
    ...
    public function setCategories_xdir()
    {
        ...
        if ($numrows > 0) {
            while (false !== (list($cid, $pid, $title, $imgurl) = $this->db->fetchRow($result))) {
    ...
    {
        $fieldtypeHandler = new FieldTypeHandler();
