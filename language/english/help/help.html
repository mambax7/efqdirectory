<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_EFQDIR_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>

    <p class="even">EFQ directory is a module that allows webmasters to manage yellow pages like business directories within their XOOPS installations.
        Because it uses customizable data fields, the administrator can set up custom made directories and categories.<br><br>

        The main features of EFQ Directory are:<br><br>

        - Multiple directory management<br>
        - Customizable fields per category<br>
        - Advanced search functionality<br>
        - Categories management<br><br>

        This module can be used in various ways, for example:<br>
    ...
    <p class="even">
        If you have questions about this module and need help, you can visit our <a href="http://xoops.org/modules/newbb/viewforum.php?forum=28/" target="_blank">Support Forums on XOOPS Website</a></p>
